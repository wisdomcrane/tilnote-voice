...
**완전 오프라인** - 모든 음성 인식이 로컬에서 처리되며, 서버로 전송되지 않습니다.
...
[faster-whisper](https://github.com/guillaumekln/faster-whisper)의 `small` 모델을 기본으로 사용합니다.

### 첫 실행 시
- 모델이 자동으로 다운로드됩니다 (약 500MB)
